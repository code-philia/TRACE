...
if __name__ == '__main__':
    ...
    # Step 7: combine all languages into one dataset
    step_7 = import_module("7_combine")
    dataset_path = os.path.join(ROOT_PATH, "dataset_fine_grain", "all")
    os.makedirs(dataset_path, exist_ok=True)
    step_7.combine(["python", "go", "java", "javascript", "typescript"], dataset_path)
...
class Seq2Seq(nn.Module):
    ...
    """
    def __init__(self, encoder,config, args, beam_size=None,max_length=None,sos_id=None,eos_id=None,mask_id=None, keep_id=None, replace_id=None, add_id=None):
        ...
        self.label_weight[keep_id] = 1.0
        self.label_weight[replace_id] = 7.0
        self.label_weight[add_id] = 12.0
